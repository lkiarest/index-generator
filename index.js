...
const ignoreDirs = ['@eaDir', 'node_modules', '.DS_Store']
const ignoreFiles = ['index.html', 'app.js', 'create-index.js', 'nohup.out', 'server.js', 'index.js', '.DS_Store', 'Thumbs.db']
